---
title: "What is Figr"
description: "Figr is an AI product design agent that turns your real product context into design-system-ready UI."
sidebarTitle: "What is Figr"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Work on an infinite canvas" icon="grip" href="/canvas-overview">
    Keep inputs, reviews, flows, PRDs, and prototypes together in one space.
  </Card>

  <Card title="Hand off to Figma and code" icon="arrow-up-right-from-square" href="/export-options">
...
<CardGroup cols={2}>
  ...
  <Card title="Understand the workflow" icon="diagram-project" href="/getting-started/tutorial/workflow-order">
