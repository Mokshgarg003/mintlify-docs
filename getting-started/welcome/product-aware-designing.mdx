...
<Tabs>
  <Tab title="Screen Sharing">
    ...
    <Frame>
      <img src="/images/screen-sharing-learning.png" alt="Figr learning from screen sharing session" />
    </Frame>
  </Tab>
...
<Steps>
  <Step title="Initial Product Tour">
    ...
    **Time investment:** 15-20 minutes once
...
<Frame>
  <img src="/images/context-improvement-graph.png" alt="Graph showing how design quality improves with more product context" />
</Frame>

**Week 1:** Designs need significant modification to fit your product
**Month 1:** Designs require minor adjustments  
**Month 3:** Designs ship with minimal changes
**Month 6:** Figr anticipates needs you haven't even articulated
