...
<Steps>
  <Step title="Start with Context">
    ...
    **Instead of starting with a blank canvas, describe your specific need:**
    ...
    <Frame>
      ![Figr interface showing design prompt input with context-rich example](/images/new-design-prompt.png)
    </Frame>
  </Step>
  ...
  <Step title="Review Initial Design">
    ...
    <Frame>
      ![Generated design with explanatory sidebar showing reasoning](/images/initial-design-result.png)
    </Frame>
    **What to look for:**
