...
1. Visit the [Chrome Web Store](https://chromewebstore.google.com/detail/figr-capture/bejnddahceggaeogmedenhaccoiikjmj) and search "Figr AI"
...
<iframe src="https://www.youtube.com/embed/-RgWMfLZIMI" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
<iframe src="https://www.youtube.com/embed/POQmqspcgIs" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
...
Build context (sort of a moodboard) from multiple sources in a single session. Useful for competitor analysis, gathering inspiration, or combining patterns from best-in-class products. Multi-site workflow:
...
<AccordionGroup>
  <Accordion title="Reference in Prompts">
  ...
  <Accordion title="Build on Existing">
  ...
  <Accordion title="Market & competitive research">
...
| **Traditional Input**                       | **Figr Chrome Extension**                  |
| ------------------------------------------- | ------------------------------------------ |
