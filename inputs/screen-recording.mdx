...
<video controls className="w-full aspect-video rounded-xl" src="https://docs.figr.design/videos/Screen Recording.mp4" />
...
- Screenshots miss interaction patterns
- Descriptions can't capture timing
- Flow diagrams oversimplify real behavior
- Edge cases get forgotten

### Screen Recording

- Captures actual click sequences and paths
- Sees loading states, transitions, animations
- Records real user flow timing
- Catches the interactions you'd forget to mention
...
- Pause between distinct actions

Avoid:
- 10+ minute recordings covering everything
- Jumping between unrelated features
- Excessive pauses or hesitation
