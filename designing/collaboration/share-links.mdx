...
<Tabs>
  <Tab title="Public Links">
    **Open sharing for broad collaboration:**
    ...
    <Frame>
      <img src="/images/share-link-creation.png" alt="Interface for creating share links with various access and security options" />
    </Frame>
...
<Steps>
  ...
  <Step title="Time-Based Access">
    **Temporary sharing with automatic expiration:**
    ...
    <Frame>
      <img src="/images/time-based-access.png" alt="Interface showing time-based access controls with expiration settings" />
    </Frame>
...
<Tabs>
  ...
  <Tab title="Analytics and Insights">
    **Feedback pattern analysis:**
    ...
    <Frame>
      <img src="/images/feedback-analytics.png" alt="Analytics dashboard showing feedback patterns, response times, and collaboration metrics" />
    </Frame>
