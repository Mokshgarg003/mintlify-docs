...
<Steps>
  <Step title="Organization Level">
    **Top-level access control:**
    ...
    <Frame>
      ![Diagram showing permission hierarchy from organization to individual project level](/images/permission-hierarchy.png)
    </Frame>
...
<Tabs>
  ...
  <Tab title="Dynamic Permissions">
    **Automated permission adjustments:**
    ...
    <Frame>
      ![Interface showing dynamic permission rules and automated adjustments](/images/dynamic-permissions.png)
    </Frame>
    **Automation triggers:**
...
<Tabs>
  <Tab title="Enterprise Security">
    **Advanced security features:**
    ...
    <Frame>
      ![Enterprise security dashboard showing access controls, audit logs, and compliance metrics](/images/enterprise-security.png)
    </Frame>
    **Security measures:**
