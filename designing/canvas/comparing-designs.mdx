...
<Tabs>
  <Tab title="Side-by-Side Views">
    **Visual comparison layouts:**
    ...
    <Frame>
      ![Two design alternatives displayed side-by-side with comparison annotations](/images/side-by-side-comparison.png)
    </Frame>
    **Layout options:**
...
<Tabs>
  <Tab title="Stakeholder Reviews">
    **Structured decision processes:**
    ...
    <Frame>
      ![Interface showing stakeholder voting and feedback on design alternatives](/images/stakeholder-comparison.png)
    </Frame>
    **Review workflow:**
