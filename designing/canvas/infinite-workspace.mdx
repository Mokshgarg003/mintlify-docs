...
sidebarTitle: "Infinite Workspace"
---
...
<Steps>
  <Step title="Zoom Controls">
    **Navigate at any scale:**
    ...
    <Frame>
      ![Canvas zoom controls showing overview to pixel-perfect detail levels](/images/canvas-zoom.png)
    </Frame>
    **Zoom levels:**
...
<Tabs>
  <Tab title="Organic Layout">
    **Natural design arrangement:**
    ...
    <Frame>
      ![Canvas showing natural clustering of related designs and iterations](/images/organic-layout.png)
    </Frame>
    **Common patterns:**
...
<Steps>
  <Step title="Real-Time Collaboration">
    **Multiple people, one canvas:**
    ...
    <Frame>
      ![Canvas showing multiple user cursors and real-time collaboration indicators](/images/collaborative-canvas.png)
    </Frame>
