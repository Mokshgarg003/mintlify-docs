...
icon: "repeat"
sidebarTitle: "Organizing Iterations"
---
...
<Tabs>
  <Tab title="Linear Evolution">
    **Sequential design progression:**
    ...
    <Frame>
      ![Canvas showing linear progression from wireframe to final design](/images/linear-iterations.png)
    </Frame>
    **When to use:**
...
<Steps>
  ...
  <Step title="Change Tracking">
    **Visualize design evolution:**
    ...
    <Frame>
      ![Interface showing design changes highlighted and annotated](/images/change-tracking.png)
    </Frame>
    **Change indicators:**
