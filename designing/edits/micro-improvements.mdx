...
<Tabs>
  <Tab title="Visual Polish">
    **Subtle enhancements that improve visual appeal:**
    ...
    <Frame>
      <img src="/images/visual-polish-comparison.png" alt="Before and after comparison showing subtle visual improvements like shadows, spacing, and typography" />
    </Frame>
...
<Steps>
  ...
  <Step title="Context-Aware Suggestions">
    **Improvements tailored to your specific product:**
    ...
    <Frame>
      <img src="/images/contextual-improvements.png" alt="Interface showing context-specific improvement suggestions based on product type and user behavior" />
    </Frame>
