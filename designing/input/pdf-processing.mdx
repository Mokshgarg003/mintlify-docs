...
<Steps>
  <Step title="Upload & Recognition">
    **Intelligent document parsing:**
    ...
    <Frame>
      ![PDF upload interface with automatic content recognition](/images/pdf-upload.png)
    </Frame>
    **What Figr extracts:**
...
<Tabs>
  <Tab title="Brand Guidelines">
    **Visual identity documentation:**
    ...
    <Frame>
      ![Brand guidelines PDF being processed to extract colors, fonts, and logo usage](/images/brand-pdf-processing.png)
    </Frame>
    **Extracted elements:**
