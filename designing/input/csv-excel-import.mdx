...
<Tabs>
  <Tab title="Spreadsheet Files">
    ...
    **File size limits:**
    ...
    <Frame>
      <img src="/images/csv-upload.png" alt="CSV upload interface showing drag and drop area with file format support" />
    </Frame>
  </Tab>
...
<Steps>
  <Step title="Upload Your Data">
    **Choose your import method:**
    ...
    <Frame>
      <img src="/images/data-import-options.png" alt="Data import interface showing different upload methods and connection options" />
    </Frame>
...
<Tabs>
  <Tab title="Tables & Lists">
    **Realistic data tables:**
    ...
    <Frame>
      <img src="/images/data-table-design.png" alt="Table design showing real customer data with varied name lengths and content" />
    </Frame>
...
<Tabs>
  <Tab title="Data Relationships">
    **Connect related datasets:**
    ...
    <Frame>
      <img src="/images/data-relationships.png" alt="Interface showing how to connect customer data with order data and analytics" />
    </Frame>
