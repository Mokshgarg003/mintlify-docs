...
icon: "image"
sidebarTitle: "Screenshots & Images"
---
    ...
    <AccordionGroup>
      <Accordion title="Interface Screenshots">
        ...
        **Why these matter:** Figr learns your actual design patterns, not just design system documentation
        ...
        <Frame>
          ![Examples of effective product screenshots showing navigation, forms, and data layouts](/images/product-screenshot-examples.png)
        </Frame>
      </Accordion>
...
<Steps>
  <Step title="Drag & Drop Upload">
    **Fastest method for multiple images:**
    ...
    <Frame>
      ![Figr interface showing drag and drop area for uploading multiple images](/images/drag-drop-upload.png)
    </Frame>
    **Supported formats:**
...
<Steps>
  ...
  <Step title="Design Token Extraction">
    **Automatic design system detection:**
    ...
    <Frame>
      ![Interface showing how Figr extracts colors, fonts, and spacing from uploaded screenshots](/images/token-extraction.png)
    </Frame>
    **Extracted tokens:**
