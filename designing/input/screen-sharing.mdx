  ...
  **Privacy first:** Only share demo environments with test data. Figr doesn't record sessions, but practice good security hygiene.
  ...
  <Step title="Start Screen Sharing">
    **Initiate from Figr project:**
    ...
    <Frame>
      ![Figr interface showing screen sharing initiation button and setup options](/images/screen-share-start.png)
    </Frame>
    **Sharing options:**
...
<Tabs>
  <Tab title="Web Applications">
    **Browser-based product demos:**
    ...
    <Frame>
      ![Screen sharing interface showing web application demo with multiple browser tabs](/images/web-app-sharing.png)
    </Frame>
    **Focus areas:**
