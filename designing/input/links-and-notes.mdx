...
<Steps>
  ...
  <Step title="Contextual Notes">
    **Add detailed context and reasoning:**
    ...
    <Frame>
      <img src="/images/contextual-notes.png" alt="Interface for adding contextual notes with rich text formatting" />
    </Frame>
...
<Steps>
  ...
  <Step title="Note Threading">
    **Connected conversations:**
    ...
    <Frame>
      <img src="/images/note-threading.png" alt="Interface showing threaded notes and discussions around design decisions" />
    </Frame>
