...
<Tabs>
  ...
  <Tab title="Information Architecture">
    **Structure content and functionality:**
    ...
    <Frame>
      <img src="/images/ia-exploration.png" alt="Information architecture diagram showing content organization and user flow mapping" />
    </Frame>
...
<Tabs>
  <Tab title="Visual Exploration">
    **Establish aesthetic direction:**
    ...
    <Frame>
      <img src="/images/visual-exploration.png" alt="Mood board and visual style exploration showing different design directions" />
    </Frame>
