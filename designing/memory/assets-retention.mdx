...
<Steps>
  ...
  <Step title="Automated Cleanup">
    **Smart asset management:**
    ...
    <Frame>
      ![Timeline showing how different assets are retained and cleaned up automatically](/images/retention-timeline.png)
    </Frame>
    **Cleanup process:**
...
<Tabs>
  <Tab title="Usage Monitoring">
    **Track your storage usage:**
    ...
    <Frame>
      ![Storage usage dashboard showing breakdown by asset type and growth over time](/images/storage-dashboard.png)
    </Frame>
    **Usage breakdown:**
