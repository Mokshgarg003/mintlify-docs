...
sidebarTitle: "Automatic Matching"
---
...
<Steps>
  <Step title="Pattern Recognition">
    **Figr analyzes your existing designs:**
    ...
    <Frame>
      ![Interface showing Figr analyzing existing designs and identifying common patterns](/images/pattern-recognition.png)
    </Frame>
...
<Tabs>
  <Tab title="Consistency Improvements">
    **Identifying and fixing inconsistencies:**
    ...
    <Frame>
      ![Interface showing suggestions for improving design consistency across components](/images/consistency-suggestions.png)
    </Frame>
...
<Tabs>
  <Tab title="Pattern Priorities">
    **Control which patterns take precedence:**
    ...
    <Frame>
      ![Interface for setting pattern matching priorities and preferences](/images/pattern-priorities.png)
    </Frame>
