...
<Steps>
  ...
  <Step title="Design Foundation">
    **Establish the framework for new interfaces:**
    ...
    <Frame>
      <img src="/images/design-foundation.png" alt="Design system foundation showing how existing patterns inform new interface creation" />
    </Frame>
...
<Steps>
  <Step title="Workflow Design">
    **Create efficient new user journeys:**
    ...
    <Frame>
      <img src="/images/workflow-design.png" alt="User journey map showing new workflow integration with existing product flows" />
    </Frame>
