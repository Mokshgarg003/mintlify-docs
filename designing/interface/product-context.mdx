...
<Tabs>
  <Tab title="Contextual Intelligence">
    **Multi-layered product understanding:**
    ...
    <Frame>
      ![Diagram showing layers of product context from user data to technical constraints](/images/product-context-layers.png)
    </Frame>
    **Context layers:**
...
<Tabs>
  <Tab title="Dashboard Design">
    **Context shapes dashboard priorities:**
    ...
    <Frame>
      ![Two dashboard designs showing how different user contexts create different layouts](/images/context-dashboard.png)
    </Frame>
