...
<Tabs>
  <Tab title="Raster Formats">
    **Pixel-based image exports:**
    ...
    <Frame>
      ![Grid showing different export formats with quality comparisons](/images/export-formats-grid.png)
    </Frame>
...
<Steps>
  ...
  <Step title="Multi-Scale Export">
    **Generate multiple resolutions simultaneously:**
    ...
    <Frame>
      ![Interface showing batch export of multiple image sizes and formats](/images/multi-scale-export.png)
    </Frame>
...
<Steps>
  <Step title="Batch Processing">
    **Efficient bulk export workflows:**
    ...
    <Frame>
      ![Batch export interface showing multiple designs being processed simultaneously](/images/batch-export-interface.png)
    </Frame>
    **Batch capabilities:**
