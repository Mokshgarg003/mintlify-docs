...
<Steps>
  <Step title="Pre-Export Preparation">
    **Optimize your design for Figma export:**
    ...
    <Frame>
      ![Interface showing design preparation checklist before Figma export](/images/figma-export-prep.png)
    </Frame>
...
<Tabs>
  ...
  <Tab title="Interactive Elements">
    **Maintain component interactivity:**
    ...
    <Frame>
      ![Figma interface showing exported interactive components with preserved states and behaviors](/images/figma-interactive-export.png)
    </Frame>
