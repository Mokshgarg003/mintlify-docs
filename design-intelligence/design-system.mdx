...
<video controls className="w-full aspect-video rounded-xl" src="https://docs.figr.design/videos/Edit Design Language.mp4" />
...
- Generic components that need restyling
- Colors that don't match your brand
- Spacing that feels "off"
- Typography that needs manual fixing
- Components that don't exist in your library

### With Design System Import

- Your actual components with correct variants
- Your exact color tokens applied automatically
- Your spacing scale enforced throughout
- Your typography hierarchy respected
- Designs that match your Figma library
...
Result:
Generic settings page with arbitrary colors, 
standard spacing, default component styles. 
Looks like a template, not your product.
```

### With Design Language
...
Result:
Settings page using your purple accent color,
your Inter typography, your 8px spacing grid,
your rounded button style, your card shadows.
Looks like it belongs in your product.
```