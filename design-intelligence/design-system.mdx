...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - Generic components that need restyling <br />- Colors that don't match your brand <br />- Spacing that feels "off" <br />- Typography that needs manual fixing <br />- Components that don't exist in your library | - Your actual components with correct variants <br />- Your exact color tokens applied automatically <br />- Your spacing scale enforced throughout <br />- Your typography hierarchy respected <br />- Designs that match your Figma library |
