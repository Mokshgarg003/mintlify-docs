...
<Tabs>
  ...
  <Tab title="Other Editors">
    1. Other code editors and tools that support SSE (Server-Sent Events) can also connect to the Figma MCP server
    2. Check your editor's documentation to confirm it supports SSE-based communication
