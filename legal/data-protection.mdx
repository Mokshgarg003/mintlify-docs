...
<Tabs>
  <Tab title="Technical Safeguards">
    **Multi-layered security architecture:**
    ...
    <Frame>
      <img src="/images/security-architecture.png" alt="Diagram showing Figr's multi-layered security infrastructure and data protection measures" />
    </Frame>
...
<Steps>
  ...
  <Step title="Data Minimization">
    **Collect only what we need, when we need it:**
    ...
    <Frame>
      <img src="/images/data-minimization.png" alt="Flowchart showing data minimization principles and practices in action" />
    </Frame>
...
<Steps>
  ...
  <Step title="Rights Exercise Process">
    **Simple, effective rights exercise:**
    ...
    <Frame>
      <img src="/images/rights-exercise-process.png" alt="User interface showing the data rights exercise process with clear steps and options" />
    </Frame>
...
Questions about our data protection practices? Contact our privacy team at privacy@figr.design.
</Callout>
