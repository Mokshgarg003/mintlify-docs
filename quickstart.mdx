...
<CardGroup cols={2}>
  <Card title="Write Content" icon="pen-to-square" color="#774cff" href="/essentials/markdown">
  ...
  <Card title="Add code examples" icon="croissant" href="/essentials/code">
