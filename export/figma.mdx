...
You need the Figr AI - Figma Sync plugin installed and connected. If you set it up for [Figma input](/inputs/figma-input), you are ready. Connect once, export anytime.
...
<CardGroup cols={2}>
  ...
  <Card title="Design system intelligence" href="/design-intelligence/design-system">
